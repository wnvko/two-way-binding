...
describe('OtherInputsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [ NoopAnimationsModule, FormsModule, HttpClientTestingModule, IgxCheckboxComponent, IGX_SIMPLE_COMBO_DIRECTIVES, IGX_INPUT_GROUP_DIRECTIVES, IGX_COMBO_DIRECTIVES, IGX_DATE_PICKER_DIRECTIVES, IgxRadioComponent, IgxRadioGroupDirective, IgcFormsModule, IGX_SELECT_DIRECTIVES, IGX_SLIDER_DIRECTIVES, IgxSwitchComponent, IGX_CALENDAR_DIRECTIVES ]
    })
    .compileComponents();
  });
